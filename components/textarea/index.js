...
`;var __decorate=function(t,e,r,n){var l,h=arguments.length,u=h<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)u=Reflect.decorate(t,e,r,n);else for(var p=t.length-1;p>=0;p--)(l=t[p])&&(u=(h<3?l(u):h>3?l(e,r,u):l(e,r))||u);return h>3&&u&&Object.defineProperty(e,r,u),u};class korTextarea extends F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_element_lit_element_h{static get styles(){return[it,i`
        :host {
          display: flex;
          align-items: center;
          min-height: 40px;
    ...
    `}constructor(){super(),this.rows=1,this.autofocus=!1,this.addEventListener("click",()=>{var t,e;this.active=!0,null===(e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("textarea"))||void 0===e||e.focus()})}handleChange(t){this.value=t.target.value,this.dispatchEvent(new CustomEvent("change",{bubbles:!0,composed:!0}))}handleClear(){this.value=void 0,this.removeAttribute("value")}attributeChangedCallback(t,e,r){super.attributeChangedCallback(t,e,r),this.dispatchEvent(new Event(t+"-changed"))}}__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:String,reflect:!0})],korTextarea.prototype,"label",void 0),__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:String,reflect:!0})],korTextarea.prototype,"value",void 0),__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:Number,reflect:!0})],korTextarea.prototype,"rows",void 0),__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:Boolean,reflect:!0})],korTextarea.prototype,"active",void 0),__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:Boolean,reflect:!0})],korTextarea.prototype,"disabled",void 0),__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:Boolean,reflect:!0})],korTextarea.prototype,"readonly",void 0),__decorate([F_Documents_HACKS_KorUI_kor_ui_node_modules_lit_reactive_element_decorators_property_e({type:Boolean,reflect:!0})],korTextarea.prototype,"autofocus",void 0),window.customElements.get("kor-textarea")||window.customElements.define("kor-textarea",korTextarea)})();