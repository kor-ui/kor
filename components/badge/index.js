          ...
          `:r.qy`
            ${this.label?r.qy`
                  <kor-text size="body-2">
                    ${this.label>999?r.qy` 999+ `:r.qy` ${this.label} `}
                  </kor-text>
                `:""}
          `}
    `}attributeChangedCallback(t,e,r){super.attributeChangedCallback(t,e,r),this.dispatchEvent(new Event(`${t}-changed`))}getStatusIcon(){let t;switch(this.status){case"error":t="cancel";break;case"warning":t="error";break;case"success":t="check_circle"}return t}}c([(0,l.MZ)({type:Number,reflect:!0})],korBadge.prototype,"label",void 0),c([(0,l.MZ)({type:String,reflect:!0})],korBadge.prototype,"status",void 0),window.customElements.get("kor-badge")||window.customElements.define("kor-badge",korBadge)})();